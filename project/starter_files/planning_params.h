...
// Planning Constants
#define P_NUM_PATHS 7                  // Num of paths (goals) — 7 lateral offsets
#define P_LOOKAHEAD_MIN 8.0            // m
#define P_LOOKAHEAD_MAX 20.0           // m
#define P_LOOKAHEAD_TIME 1.5           // s
#define P_GOAL_OFFSET 1.5              // m — lateral distance between adjacent path goals
#define P_ERR_TOLERANCE 1e-4           // Newton-Raphson convergence tolerance
...
#define P_NUM_POINTS_IN_SPIRAL 20      // Num of points in the spiral (smoother path)
#define P_STOP_THRESHOLD_DISTANCE \
  P_LOOKAHEAD_MIN / P_NUM_POINTS_IN_SPIRAL * 2  // m

#define P_LANE_WIDTH 4.0               // Lane width in meters
#define P_DIST_COLLISION_THRESH 4.5    // Collision detection threshold distance (meters)
#define P_CIRCLE_DIST 1.5              // Distance between collision check circles along vehicle
#define P_NUM_CIRCLES 3                // Number of circles used to represent vehicle footprint

// Lane change hysteresis: block further changes for this many ticks (20ms each)
#define P_LANE_CHANGE_COOLDOWN_TICKS 150  // 3 seconds at 20ms per tick
